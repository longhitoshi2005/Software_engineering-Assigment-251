...
/**
 * Feedback Detail inside dashboard/[id]
 * - ĐÃ BỎ: Attachments & Coordinator Notes sections (theo yêu cầu)
 * - Giữ: breadcrumb, header, rating + sentiment, metadata, comment, prev/next
 */
