...
const TeacherProfile: React.FC = () => {
  ...
  const contactFieldClass = isEditing
    ? "rounded-lg bg-white border border-light-light-blue px-3 py-2 outline-none focus:ring-2 focus:ring-light-light-blue transition"
    : "rounded-lg bg-black/5 border border-soft-white-blue px-3 py-2 text-black/60 cursor-not-allowed";
